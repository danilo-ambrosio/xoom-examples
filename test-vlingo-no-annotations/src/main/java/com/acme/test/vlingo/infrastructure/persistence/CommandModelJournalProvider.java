...
public class CommandModelJournalProvider  {
  ...
  public static CommandModelJournalProvider using(final Stage stage, final SourcedTypeRegistry registry, final Dispatcher dispatcher) {
    ...
    entryAdapterProvider.registerAdapter(ProjectRenamed.class, new ProjectRenamedAdapter());
    entryAdapterProvider.registerAdapter(ProjectDefined.class, new ProjectDefinedAdapter());
    ...
    registry.register(new Info(journal, ProjectEntity.class, ProjectEntity.class.getSimpleName()));
